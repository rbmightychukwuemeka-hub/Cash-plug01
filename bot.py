...
WEBAPP_URL = "https://cashplug01.netlify.app"

# === ADMIN CONTROLLED SETTINGS ===
settings = {
    "vnum_api_key": "uw1w7rscldpmkrhp9lmuf5a8f2yc1lhv",
    "vnum_api_url": "https://no1verify.com/api", # Backend only - not shown to users
    "referral_bonus": 200,
    "listing_fee": 200,
    "deposit_bank": "Opay",
...
async def broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    count = sum(1 for uid in users if await context.bot.send_message(uid, f"📢 {msg}") or True)
